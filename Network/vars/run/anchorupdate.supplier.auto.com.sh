...
export ORDERER_ADDRESS=192.168.68.141:7012
...
jq '.channel_group.groups.Application.groups."supplier-auto-com".values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "192.168.68.141","port": 7005}]},"version": "0"}}' autochannel_current_config.json > autochannel_modified_anchor_config.json
