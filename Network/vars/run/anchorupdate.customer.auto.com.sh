...
jq '.channel_group.groups.Application.groups."customer-auto-com".values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "192.168.68.141","port": 7007}]},"version": "0"}}' autochannel_current_config.json > autochannel_modified_anchor_config.json
